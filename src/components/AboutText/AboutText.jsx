...
function AboutText(){
    ...
    return(
        <section ref={ref} className="project-detail-text mt-5">
            <div className="container">
                <div className="row">
                    <div className="text-detail-button">
                        <h1 className='text-detail-button-items' style={{...fadeInStyle(0.1)}}>We’re a <span style={{ color: '#ffc107', fontStyle: "italic"}}>Team</span> of Trusted Builders Providing Comprehensive Home Improvement and <span style={{ color: '#ffc107', fontStyle: "italic"}}>Renovation Services</span></h1>
                    </div>
                    ...
                    <div className="text-detail-button-description mt-3">
                        <h3 style={{...fadeInStyle(0.5), color: '#E77B2D', fontStyle: "italic"}}>We offer a full range of interior services including drywall replacement, professional painting for walls and ceilings, light fixture installation, electrical upgrades, and complete plumbing solutions — all delivered with expert precision.</h3>
                    </div>
                    ...
                    <div className="text-detail-button-description ps-5" style={{...fadeInStyle(0.5)}}>
                    ...
                    <div className="text-detail-button-description ps-5" style={{...fadeInStyle(0.7)}}>
